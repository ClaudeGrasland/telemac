...
This notebook present the functions used by the interface TELEMAC presented in the paper published in the journal *Frontiers*
...
gg<-g + geom_edge_link(aes(edge_width=success, edge_colour = index),
  ...
  geom_node_label(aes(label = where1, size = 16*sqrt(success)),alpha =1,label.size=0.4,show.legend = FALSE)
